    ...
    <div class="container fadeInUp">
      <div class="row">
        ...
        <div class="col-md-6 col-md-push-3">
          <div class="form">
            <form action="controller/gestionPosts/deposerAnnonce_page.php?categorie=autre" method="post" role="form" name="myForm" onsubmit="return validateForm(<?php echo $_SESSION['categorie']; ?>)" enctype="multipart/form-data" >
