...
<body>
  ...
  <section id="contact">
    <div class="container fadeInUp">
      <div class="row">
        <div class="col-md-12">
          <h3 class="section-title">Annonce Musiciens</h3>
        ...
        <div class="col-md-6 col-md-push-3">
          <div class="form">
            <form action="controller/gestionPosts/deposerAnnonce_page.php?categorie=musicien" method="post" role="form" name="myForm" onsubmit="return validateForm(<?php echo $_SESSION['categorie']; ?>)" enctype="multipart/form-data" >
