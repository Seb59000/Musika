      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="index.php?page=espacePerso">Espace Perso</a>
                  <ul>
                    <li><a href="controleur/espacePerso/deconnexion_page.php">Se déconnecter</a></li>
                  </ul>
          </li>
          <?php
              } else { 
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-md-push-3">
          <div class="form">
            ...
            <form action="controller/espacePerso/recuperationMotPasse_page2.php" method="post" role="form" name="myForm">
