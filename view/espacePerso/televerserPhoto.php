...
<body>
  ...
  <section id="contact">
    <div class="container fadeInUp">
      <div class="row">
        <div class="col-md-12">
          <h3 class="section-title">Changer votre photo de profil</h3>
        ...
        <div class="col-md-6 col-md-push-3">
          <div class="form">
			<form action="controller/espacePerso/upload.php" method="post" enctype="multipart/form-data">
              ...
              <div class="text-center"><button type="submit" value="Upload Image" name="submit">Télécharger la photo</button></div>
