...
<?php
  for($x = 0; $x < $arrlength; $x++) {
    ?>
        ...
        <div class="col-md-3">
          ...
          <a class="btnSubmitLike6" href="controller/gestionPosts/supprimerPhoto_page.php?adresse=<?php echo '../../public/img/PhotosGalerie/'.$arrayPhotos[$x]->get_idPhoto().$arrayPhotos[$x]->get_TypePhoto()."&idPhoto=".$arrayPhotos[$x]->get_idPhoto()."&admin=1"; ?>">
 ...
 <!-- <a href="" class="btnSubmitLike2">Page <?php $page = ($indexPremierePhoto/8)+1; echo $page; ?></a> -->
  ...
  ?>
  <a href="index.php?page=administrer&reculerPhoto=1" class="btnSubmitLike2">Page précédente</a>
  <?php 
  } 
  ...
  if ($nbPage>8) {
    ...
    $iFinBoucle1 = ($indexPremierePhoto/8);
      ...
      for ( $i = $iDepartBoucle1 ; $i < $iFinBoucle1 ; $i++ ) { 
        if ($i>-1){
          ?>
          <a href="index.php?page=administrer&indexPremierePhoto=<?php echo ($i); ?>" class="btnSubmitLike2"><?php echo ($i +1); ?></a>
          <?php  
        }       
      }
...
// Fin affichage des pages sous forme de boutons //
 ////////////////////////////////////////////////
  ...
  ?>
  <a href="index.php?page=administrer&avancerPhoto=1" class="btnSubmitLike2">Page suivante</a>
      </div>
    </section>
  <?php  
  }  
