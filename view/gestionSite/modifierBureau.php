...
<head>
  <meta charset="utf-8">
  <title>Modifier le bureau</title>
...
<body>
  ...
  <section id="contact">
    <div class="container fadeInUp">
      <div class="row">
        <div class="col-md-12">
          <h3 class="section-title">Modifier le bureau</h3>
        ...
        <div class="col-md-6 col-md-push-3">
          <div class="form">
            <form action="controller/gestionSite/modifierBureau_page.php?categorie=autre" method="post" role="form" name="myForm">
              <div class="form-group">
                <h3>
                  <?php 
                    echo $_GET['pseudo']; 
                    if ($fonctionOfficielle == 1)
                      echo ' secrétaire';
                    else if ($fonctionOfficielle == 2)
                      echo ' trésorier';
                    else if ($fonctionOfficielle == 3)
                      echo ' président';?>

                </h3>
              </div>              
              <div class="form-group">
                <input type="text" class="form-control" name="fonction" id="fonction" rows="5" placeholder="Message affiché en page d'accueil :" required />
              </div>
